<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<FiftyOneDegrees.Models.ScreenInchesDiagonalRoundedRange>" %>
...
<div class="epi-criteria-grouping" data-property-name="ScreenInchesDiagonalRounded" data-min="<% =Model.Min %>" data-max="<% =Model.Max %>" >
    <style>
    ...
    <% 
        var upgrade = Html.UpgradeLink("ScreenInchesDiagonalRounded");
        if (upgrade == null) {
    %>
