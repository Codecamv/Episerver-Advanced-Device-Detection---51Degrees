<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<FiftyOneDegrees.Models.PlatformVersion>" %>
...
<div class="epi-criteria-grouping" data-property-name="PlatformVersion">
    ...
    <% =Html.UpgradeLink("PlatformVersion") %>
</div>