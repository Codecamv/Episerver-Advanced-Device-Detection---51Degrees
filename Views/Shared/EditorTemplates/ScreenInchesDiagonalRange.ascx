<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<FiftyOneDegrees.Models.ScreenInchesDiagonalRange>" %>
...
<div class="epi-criteria-grouping" data-property-name="ScreenInchesDiagonal" data-min="<% =Model.Min %>" data-max="<% =Model.Max %>" >
    <style>
    ...
    <% 
        var upgrade = Html.UpgradeLink("ScreenInchesDiagonal");
        if (upgrade == null) {
    %>
