<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<FiftyOneDegrees.Models.{Name}Range>" %>
...
<div class="epi-criteria-grouping" data-property-name="{Name}" data-min="<% =Model.Min %>" data-max="<% =Model.Max %>" >
    <style>
    ...
    <% 
        var upgrade = Html.UpgradeLink("{Name}");
        if (upgrade == null) {
    %>
